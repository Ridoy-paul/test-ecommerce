        ...
        <div class="col-md-4 col-xl-3">
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    <img src="{{ asset('admin_resources/img/avatars/avatar-4.jpg') }}" alt="Christina Mason"
            ...
            <div class="card">
                ...
                <div class="card-body h-100">
                    ...
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin_resources/img/avatars/avatar-5.jpg') }}" width="36" height="36"
                    ...
                    <hr />
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin_resources/img/avatars/avatar.jpg') }}" width="36" height="36"
                    ...
                    <hr />
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin_resources/img/avatars/avatar-4.jpg') }}" width="36" height="36"
                    ...
                    <hr />
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin_resources/img/avatars/avatar-2.jpg') }}" width="36" height="36"
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="row g-0 mt-1">
                                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                    <img src="{{ asset('admin_resources/img/photos/unsplash-1.jpg') }}"
                                        class="img-fluid pe-2" alt="Unsplash">
                                </div>
                                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                    <img src="{{ asset('admin_resources/img/photos/unsplash-2.jpg') }}"
                                        class="img-fluid pe-2" alt="Unsplash">
                                </div>
                            </div>
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-start mt-1">
                                <a class="pe-3" href="#">
                                    <img src="{{ asset('admin_resources/img/avatars/avatar-4.jpg') }}" width="36"
